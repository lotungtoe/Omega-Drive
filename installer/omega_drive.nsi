...
; Custom: optional section for video processing binaries (ffmpeg/ffprobe)
...
Section Uninstall
  ...
  ; Delete downloaded binaries
  Delete "$INSTDIR\binaries\ffmpeg-x86_64-pc-windows-msvc.exe"
  Delete "$INSTDIR\binaries\ffprobe-x86_64-pc-windows-msvc.exe"
  Delete "$INSTDIR\binaries\yt-dlp-x86_64-pc-windows-msvc.exe"
  Delete "$INSTDIR\binaries\deno-x86_64-pc-windows-msvc.exe"
